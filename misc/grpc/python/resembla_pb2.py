...
_RESEMBLARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='measure', full_name='resembla.server.ResemblaResponse.measure', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='score', full_name='resembla.server.ResemblaResponse.score', index=2,
